...
public class CategoryController {
    ...
    public ResponseResult findCate(QueryInfo queryInfo, HttpServletRequest request){
        ...
        // token失效
        result.setMeta(new Meta(501,"获取商品分类失败, token失效"));
        return result;
    }
    ...
    public ResponseResult checkCateName(String name, HttpServletRequest request){
        ...
        // token失效
        result.setMeta(new Meta(501,"校验商品分类名称失败, token失效"));
        return result;
    }
    ...
    public ResponseResult saveCate(@RequestBody Category category, HttpServletRequest request){
        ...
        // token失效
        result.setMeta(new Meta(501,"保存商品分类失败, token失效"));
        return result;
    }
    ...
    public ResponseResult cateStatus(Category category, HttpServletRequest request){
        ...
        // token失效
        result.setMeta(new Meta(501,"修改分类状态失败, token失效"));
        return result;
    }
    ...
    public ResponseResult deleteCate(Integer id, HttpServletRequest request){
        ...
        // token失效
        result.setMeta(new Meta(501,"删除商品分类失败, token失效"));
        return result;
    }
...
/*
        ...
        if(JwtUtil.verify(request.getHeader(AUTH))){
            try{
                ...
                result.setMeta(new Meta(201,"成功"));
                return result;
            } catch (Exception e){
                e.printStackTrace();
                result.setMeta(new Meta(500,"失败, 产生意外"));
                return result;
            }
        }
        // token失效
        result.setMeta(new Meta(501,"失败, token失效"));
        return result;
